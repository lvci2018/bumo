...
enum FeeConfig_Type {
  ...
  FeeConfig_Type_PROCESS_ORDER_FEE = 10,
  FeeConfig_Type_UPDATE_ASSET_PROPERTY_FEE = 11,
...
const FeeConfig_Type FeeConfig_Type_Type_MAX = FeeConfig_Type_UPDATE_ASSET_PROPERTY_FEE;
...
class FeeConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protocol.FeeConfig) */ {
 public:
  ...
  static const Type PROCESS_ORDER_FEE =
    FeeConfig_Type_PROCESS_ORDER_FEE;
  static const Type UPDATE_ASSET_PROPERTY_FEE =
    FeeConfig_Type_UPDATE_ASSET_PROPERTY_FEE;
  ...
  void clear_process_order_fee();
  static const int kProcessOrderFeeFieldNumber = 10;
  ::google::protobuf::int64 process_order_fee() const;
  void set_process_order_fee(::google::protobuf::int64 value);

  // optional int64 update_asset_property_fee = 11;
  void clear_update_asset_property_fee();
  static const int kUpdateAssetPropertyFeeFieldNumber = 11;
  ::google::protobuf::int64 update_asset_property_fee() const;
  void set_update_asset_property_fee(::google::protobuf::int64 value);
 ...
 private:
  ...
  ::google::protobuf::int64 process_order_fee_;
  ::google::protobuf::int64 update_asset_property_fee_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_consensus_2eproto();
  friend void protobuf_AssignDesc_consensus_2eproto();
  friend void protobuf_ShutdownFile_consensus_2eproto();
...
// optional int64 process_order_fee = 10;
inline void FeeConfig::clear_process_order_fee() {
  process_order_fee_ = GOOGLE_LONGLONG(0);
}
inline ::google::protobuf::int64 FeeConfig::process_order_fee() const {
  // @@protoc_insertion_point(field_get:protocol.FeeConfig.process_order_fee)
  return process_order_fee_;
}
inline void FeeConfig::set_process_order_fee(::google::protobuf::int64 value) {
...
// optional int64 update_asset_property_fee = 11;
inline void FeeConfig::clear_update_asset_property_fee() {
  update_asset_property_fee_ = GOOGLE_LONGLONG(0);
}
inline ::google::protobuf::int64 FeeConfig::update_asset_property_fee() const {
  // @@protoc_insertion_point(field_get:protocol.FeeConfig.update_asset_property_fee)
  return update_asset_property_fee_;
}
inline void FeeConfig::set_update_asset_property_fee(::google::protobuf::int64 value) {
